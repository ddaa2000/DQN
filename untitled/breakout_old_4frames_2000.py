...
resize = T.Compose([T.ToPILImage(),
                    T.Resize((42,42), interpolation=Image.CUBIC),#试着在这里直接变成84*84
...
def select_action(state):
    ...
    if steps_done <= 10000:
        eps_threshold = EPS_START - (EPS_START-EPS_END) * steps_done/10000
    else:
        eps_threshold = 0.1
    steps_done += 1
    #print(eps_threshold)
...
PATH = './Breakout_old_4frames_2000.pth'
